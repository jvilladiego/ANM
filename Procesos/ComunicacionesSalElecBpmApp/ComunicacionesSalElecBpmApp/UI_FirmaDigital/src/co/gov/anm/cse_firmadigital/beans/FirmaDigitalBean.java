package co.gov.anm.cse_firmadigital.beans;
...
import co.gov.anm.cse_firmadigital.utils.ADFUtils;

import co.gov.anm.cse_firmadigital.utils.JsfUtil;
...
public class FirmaDigitalBean implements Serializable{
    @SuppressWarnings("compatibility:1417691913517395515")
    ...
    public void firmaDigitalAL(ActionEvent ae) {
        logger.info("firmaDigitalAL INI");
         ...
         */
            ...
            /**************************
             * Fecha: 22Nov2024 
             * Actualizacion de la url por defecto
             * Autor: Adrian M.
             * ************************/
            ...
            try {
                ...
                logger.error("firmaDigitalAL IOException error", ioe);
            } catch (Exception e) {
                firmado = false;
                JsfUtil.errorMenssage(null, "Error al ejecutar el servicio de Firma Digital");
                logger.error("firmaDigitalAL Exception error", e);
            }
        } else {
            firmado = false;
        ...
        logger.info("firmaDigitalAL FIN");
    }
