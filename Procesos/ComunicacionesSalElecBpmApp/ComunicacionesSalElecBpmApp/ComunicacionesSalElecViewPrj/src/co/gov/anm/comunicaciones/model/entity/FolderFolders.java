...
@Entity
@NamedQueries({ 
        @NamedQuery(name = "FolderFolders.findAll", query = "select o from FolderFolders o") ,
        @NamedQuery(name = "FolderFolders.findByParentGuid", query = "select o from FolderFolders o where o.fparentguid = :p_parent_guid order by o.ffoldername"),
        @NamedQuery(name = "FolderFolders.findByFolderName", query = "select o from FolderFolders o where o.ffoldername = :p_folder_name order by o.ffoldername")
})
public class FolderFolders implements Serializable {
    private static final long serialVersionUID = 2680959433016242447L;
    ...
    public FolderFolders(BigDecimal fallocatedfoldersize, String fallocatorparentfolderguid, String fapplication,
                         ...
                         BigDecimal fislibrary, BigDecimal fisreadonly, Timestamp flastmodifieddate,
                         String flastmodifier, BigDecimal flibrarytype, String fowner, String fparentguid,
                         BigDecimal fpromptformetadata, String frealitemguid, String fsecuritygroup,
                         String ftargetguid) {
