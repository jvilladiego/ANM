...
@Entity
@NamedQueries({ @NamedQuery(name = "TipoDocumentalTramite.findAll", query = "select o from TipoDocumentalTramite o"),
                @NamedQuery(name = "TipoDocumentalTramite.tiposDocumentalesTramites", query = "select o from TipoDocumentalTramite o where o.idtramite=:p_id_tramite order by o.nombretipodocumental")
            })
@Table(name = "ANM_TIPODTALSEGUNTRAMITE")
public class TipoDocumentalTramite implements Serializable {
    private static final long serialVersionUID = 4147006923543892845L;
    @Id
