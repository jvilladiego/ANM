...
@Entity
@NamedQueries({ @NamedQuery(name = "Tramite.findAll", query = "select o from Tramite o order by o.tramite") })
@Table(name = "ANM_TRAMITE_TB")
public class Tramite implements Serializable {
    private static final long serialVersionUID = 6838362896590357104L;
    @Id
