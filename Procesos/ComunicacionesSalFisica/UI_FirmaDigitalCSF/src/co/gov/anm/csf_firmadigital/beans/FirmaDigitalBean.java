package co.gov.anm.csf_firmadigital.beans;
...
import co.gov.anm.csf_firmadigital.utils.ADFUtils;
import co.gov.anm.csf_firmadigital.utils.JsfUtil;
...
public class FirmaDigitalBean implements Serializable{
    @SuppressWarnings("compatibility:-7913237564911087741")
    ...
    public void firmaDigitalAL(ActionEvent ae) {
         ...
         */
            ...
            rootRequest.setUrl("https://www.anm.gov.co");
