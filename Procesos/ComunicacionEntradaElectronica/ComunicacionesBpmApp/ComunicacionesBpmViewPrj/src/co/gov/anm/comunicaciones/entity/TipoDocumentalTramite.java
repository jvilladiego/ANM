...
@Entity
@NamedQueries({ @NamedQuery(name = "TipoDocumentalTramite.findAll", 
                            query = "select o from TipoDocumentalTramite o order by o.nombretipodocumental"),
                @NamedQuery(name = "TipoDocumentalTramite.tiposDocumentalesTramites", 
                            query = "select o from TipoDocumentalTramite o where o.idtramite=:p_id_tramite order by o.nombretipodocumental")
            })
@Table(name = "ANM_TIPODTALSEGUNTRAMITE")
public class TipoDocumentalTramite implements Serializable {
    private static final long serialVersionUID = 135756145793727066L;
    @Id
    ...
    public TipoDocumentalTramite(BigDecimal idTipodtalseguntramite, BigDecimal idtipodtal, BigDecimal idtramite,
