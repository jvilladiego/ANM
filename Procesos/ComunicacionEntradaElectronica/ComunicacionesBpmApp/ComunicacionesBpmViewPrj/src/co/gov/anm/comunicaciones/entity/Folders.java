...
@Entity
@NamedQueries({ @NamedQuery(name = "Folders.findAll", 
                            query = "select o from Folders o order by o.ffoldername"),
...
public class Folders implements Serializable {
    private static final long serialVersionUID = 4032489515095124659L;
