...
public class CommonJSFBean implements Serializable{
    ...
    private static final long serialVersionUID = -4257313515490086061L;
    ...
    /**
         *Método que se encarga de asignar la operación correspondiente a un boton.
         *Este método llama al metodo setOperation de la clase InvokeActionBean.
         * @param action
         */
