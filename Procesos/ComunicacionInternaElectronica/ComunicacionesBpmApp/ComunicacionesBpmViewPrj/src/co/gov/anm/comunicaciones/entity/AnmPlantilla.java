...
public class AnmPlantilla implements Serializable {
    private static final long serialVersionUID = -4082780587051368472L;
    ...
    public String toString() {
        ...
        buffer.append(',');
        buffer.append("fechaModificacion=");
        buffer.append(getFechaModificacion());
        buffer.append(',');
        buffer.append("idAnmPlantilla=");
        buffer.append(getIdAnmPlantilla());
        buffer.append(',');
        buffer.append("ipCreacion=");
        buffer.append(getIpCreacion());
        buffer.append(',');
        buffer.append("ipModificacion=");
        buffer.append(getIpModificacion());
        buffer.append(',');
        buffer.append("nombre=");
        buffer.append(getNombre());
        buffer.append(',');
        buffer.append("parametroReemplazo=");
        buffer.append(getParametroReemplazo());
        buffer.append(',');
        buffer.append("ruta=");
        buffer.append(getRuta());
        buffer.append(',');
        buffer.append("usuarioCreacion=");
        buffer.append(getUsuarioCreacion());
        buffer.append(',');
        buffer.append("usuarioModificacion=");
        buffer.append(getUsuarioModificacion());
        buffer.append(',');
