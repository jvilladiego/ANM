...
public class SgdUsuarioRol implements Serializable {
    private static final long serialVersionUID = -4984583660084042289L;
    ...
    public SgdUsuarioRol(Date fechaActualizacion, Date fechaCreacion, Long idRol, SgdUsuario sgdUsuario,
